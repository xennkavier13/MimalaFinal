...
public class PyrotharScreen extends JPanel {
    ...
    private final String characterName = "Pyrothar"; // Character for this screen
    ...
    private final String gifResourcePath = "/assets/CharacterSelectionScreen/CharacterScreen/PyrotharSelection.gif";
    ...
    private void setupButtons() {
        ...
        String contOffPath = "/assets/CharacterSelectionScreen/CharacterScreenButtons/PyrotharButtons/offButton.png";
        String contHoverPath = "/assets/CharacterSelectionScreen/CharacterScreenButtons/PyrotharButtons/hoverButton.png";

        // --- Back Button ---
        JLabel backButton = createButton(backOffPath, backHoverPath, 0, 30, () -> {
            System.out.println("Back button clicked on PyrotharScreen");
        ...
        JLabel continueButton = createButton(contOffPath, contHoverPath, 1200, 890, () -> {
            System.out.println("Continue button clicked on PyrotharScreen. Mode: " + this.mode);
