...
public class PyrotharScreen extends JPanel{
    private final ImageIcon pyrotharGif;
    private final JFrame frame;

    public PyrotharScreen(JFrame frame) {
        this.frame = frame;
        pyrotharGif = new ImageIcon("MimalaFinal\\MimalaFinal\\src\\assets\\CharacterSelectionScreen\\CharacterScreen\\PyrotharSelection.gif");
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.drawImage(pyrotharGif.getImage(), 0, 0, getWidth(), getHeight(), this);
    }
}
