...
public class AuricannonScreen extends JPanel {
    ...
    private final String characterName = "Auricannon"; // Character for this screen
    ...
    private final String gifResourcePath = "/assets/CharacterSelectionScreen/CharacterScreen/AuricannonSelection.gif";
