...
public class AuricannonScreen extends JPanel{
    private final ImageIcon auricannonGif;
    private final JFrame frame;

    public AuricannonScreen(JFrame frame) {
        this.frame = frame;
        auricannonGif = new ImageIcon("MimalaFinal\\MimalaFinal\\src\\assets\\CharacterSelectionScreen\\CharacterScreen\\AuricannonSelection.gif");
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.drawImage(auricannonGif.getImage(), 0, 0, getWidth(), getHeight(), this);
    }
}
