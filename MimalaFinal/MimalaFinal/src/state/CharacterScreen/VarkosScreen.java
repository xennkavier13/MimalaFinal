...
public class VarkosScreen extends JPanel {
    ...
    private final String characterName = "Varkos"; // Character for this screen
    ...
    private final String gifResourcePath = "/assets/CharacterSelectionScreen/CharacterScreen/VarkosSelection.gif";
    ...
    private void setupButtons() {
        ...
        String contOffPath = "/assets/CharacterSelectionScreen/CharacterScreenButtons/VarkosButtons/offButton.png";
        String contHoverPath = "/assets/CharacterSelectionScreen/CharacterScreenButtons/VarkosButtons/hoverButton.png";

        // --- Back Button ---
        JLabel backButton = createButton(backOffPath, backHoverPath, 0, 30, () -> {
            System.out.println("Back button clicked on VarkosScreen");
        ...
        JLabel continueButton = createButton(contOffPath, contHoverPath, 1200, 890, () -> {
            System.out.println("Continue button clicked on VarkosScreen. Mode: " + this.mode);
