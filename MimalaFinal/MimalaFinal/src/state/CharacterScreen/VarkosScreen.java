...
public class VarkosScreen extends JPanel{
    private final ImageIcon varkosGif;
    private final JFrame frame;

    public VarkosScreen(JFrame frame) {
        this.frame = frame;
        varkosGif = new ImageIcon("MimalaFinal\\MimalaFinal\\src\\assets\\CharacterSelectionScreen\\CharacterScreen\\VarkosSelection.gif");
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.drawImage(varkosGif.getImage(), 0, 0, getWidth(), getHeight(), this);
    }
}
