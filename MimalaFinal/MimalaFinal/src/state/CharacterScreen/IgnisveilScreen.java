...
public class IgnisveilScreen extends JPanel {
    ...
    private final String characterName = "Ignisveil"; // Character for this screen
    ...
    private final String gifResourcePath = "/assets/CharacterSelectionScreen/CharacterScreen/IgnisveilSelection.gif";
    ...
    private void setupButtons() {
        ...
        String contOffPath = "/assets/CharacterSelectionScreen/CharacterScreenButtons/IgnisveilButtons/offButton.png";
        String contHoverPath = "/assets/CharacterSelectionScreen/CharacterScreenButtons/IgnisveilButtons/hoverButton.png";

        // --- Back Button ---
        JLabel backButton = createButton(backOffPath, backHoverPath, 0, 30, () -> {
            System.out.println("Back button clicked on IgnisveilScreen");
        ...
        JLabel continueButton = createButton(contOffPath, contHoverPath, 1200, 890, () -> {
            System.out.println("Continue button clicked on IgnisveilScreen. Mode: " + this.mode);
