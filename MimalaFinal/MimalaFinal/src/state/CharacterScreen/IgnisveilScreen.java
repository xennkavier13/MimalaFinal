...
public class IgnisveilScreen extends JPanel{
    private final ImageIcon astridraGif;
    private final JFrame frame;

    public IgnisveilScreen(JFrame frame) {
        this.frame = frame;
        astridraGif = new ImageIcon("MimalaFinal\\MimalaFinal\\src\\assets\\CharacterSelectionScreen\\CharacterScreen\\IgnisveilSelection.gif");
