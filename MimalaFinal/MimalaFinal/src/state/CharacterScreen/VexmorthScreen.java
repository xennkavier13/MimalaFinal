...
public class VexmorthScreen extends JPanel {
    ...
    private final String characterName = "Vexmorth"; // Character for this screen
    ...
    private final String gifResourcePath = "/assets/CharacterSelectionScreen/CharacterScreen/VexmorthSelection.gif";
    ...
    private void setupButtons() {
        ...
        String contOffPath = "/assets/CharacterSelectionScreen/CharacterScreenButtons/VexmorthButtons/offButton.png";
        String contHoverPath = "/assets/CharacterSelectionScreen/CharacterScreenButtons/VexmorthButtons/hoverButton.png";

        // --- Back Button ---
        JLabel backButton = createButton(backOffPath, backHoverPath, 0, 30, () -> {
            System.out.println("Back button clicked on VexmorthScreen");
        ...
        JLabel continueButton = createButton(contOffPath, contHoverPath, 1200, 890, () -> {
            System.out.println("Continue button clicked on VexmorthScreen. Mode: " + this.mode);
