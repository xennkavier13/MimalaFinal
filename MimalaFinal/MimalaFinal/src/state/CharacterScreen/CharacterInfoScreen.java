...
public class CharacterInfoScreen extends JPanel {
    ...
    public CharacterInfoScreen(JFrame frame, String characterName, String mode, String firstPlayerSelection) {
        this.frame = frame;
        ...
        JLabel titleLabel = new JLabel((firstPlayerSelection == null ? "Player 1" : "Player 2") + " considers: " + characterName, SwingConstants.CENTER);
        titleLabel.setFont(new Font("Arial", Font.BOLD, 30));
        titleLabel.setForeground(Color.WHITE); // Adjust color as needed
        titleLabel.setBounds(0, 10, 1920, 50); // Adjust position
        add(titleLabel);
    }
