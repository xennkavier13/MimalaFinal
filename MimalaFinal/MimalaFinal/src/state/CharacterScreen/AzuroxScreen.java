...
public class AzuroxScreen extends JPanel {
    ...
    private final String gifResourcePath = "/assets/CharacterSelectionScreen/CharacterScreen/AzuroxSelection.gif";
    ...
    private void setupButtons() {
        ...
        String contOffPath = "/assets/CharacterSelectionScreen/CharacterScreenButtons/AzuroxButtons/offButton.png";
        String contHoverPath = "/assets/CharacterSelectionScreen/CharacterScreenButtons/AzuroxButtons/hoverButton.png";

        // --- Back Button ---
        JLabel backButton = createButton(backOffPath, backHoverPath, 0, 30, () -> {
            System.out.println("Back button clicked on AzuroxScreen");
        ...
        JLabel continueButton = createButton(contOffPath, contHoverPath, 1200, 890, () -> {
            System.out.println("Continue button clicked on AzuroxScreen. Mode: " + this.mode);
