...
public class AzuroxScreen extends JPanel{
    private final ImageIcon azuroxGif;
    private final JFrame frame;

    public AzuroxScreen(JFrame frame) {
        this.frame = frame;
        azuroxGif = new ImageIcon("MimalaFinal\\MimalaFinal\\src\\assets\\CharacterSelectionScreen\\CharacterScreen\\AzuroxSelection.gif");
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.drawImage(azuroxGif.getImage(), 0, 0, getWidth(), getHeight(), this);
    }
}
