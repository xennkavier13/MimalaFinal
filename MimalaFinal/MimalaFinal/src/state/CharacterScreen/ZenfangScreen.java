...
public class ZenfangScreen extends JPanel {
    ...
    private final String characterName = "Zenfang"; // Character for this screen
    ...
    private final String gifResourcePath = "/assets/CharacterSelectionScreen/CharacterScreen/ZenfangSelection.gif";
    ...
    private void setupButtons() {
        ...
        String contOffPath = "/assets/CharacterSelectionScreen/CharacterScreenButtons/ZenfangButtons/offButton.png";
        String contHoverPath = "/assets/CharacterSelectionScreen/CharacterScreenButtons/ZenfangButtons/hoverButton.png";

        // --- Back Button ---
        JLabel backButton = createButton(backOffPath, backHoverPath, 0, 30, () -> {
            System.out.println("Back button clicked on ZenfangScreen");
        ...
        JLabel continueButton = createButton(contOffPath, contHoverPath, 1200, 890, () -> {
            System.out.println("Continue button clicked on ZenfangScreen. Mode: " + this.mode);
