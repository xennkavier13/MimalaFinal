...
public class ZenfangScreen extends JPanel{
    private final ImageIcon zenfangGif;
    private final JFrame frame;

    public ZenfangScreen(JFrame frame) {
        this.frame = frame;
        zenfangGif = new ImageIcon("MimalaFinal\\MimalaFinal\\src\\assets\\CharacterSelectionScreen\\CharacterScreen\\ZenfangSelection.gif");
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.drawImage(zenfangGif.getImage(), 0, 0, getWidth(), getHeight(), this);
    }
}
